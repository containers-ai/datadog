...
get_repo_url()
{
    ...
    do
        read -r -p "$(tput setaf 2)Please input private repository URL (e.g., repo.example.com/datadog): $(tput sgr 0) " repo_url </dev/tty
...
download_files()
{
    ...
    do
        if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/${tag_number}/deploy/${file_name} -O; then
    ...
    if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/master/deploy/federatorai-launcher.sh -O; then
    ...
    # Installer
    ansible_install_file_lists=`curl --silent https://api.github.com/repos/containers-ai/datadog/contents/deploy/${ansible_folder_name}?ref=${tag_number} 2>&1|grep "\"name\":"|cut -d ':' -f2|cut -d '"' -f2|grep -v "uninstaller"`
    ...
    do
        if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/${tag_number}/deploy/${ansible_folder_name}/${file} -o $ansible_folder_name/${file}; then
    ...
    ansible_uninstall_file_lists=`curl --silent https://api.github.com/repos/containers-ai/datadog/contents/deploy/${ansible_folder_name}/uninstaller?ref=${tag_number} 2>&1|grep "\"name\":"|cut -d ':' -f2|cut -d '"' -f2`
    ...
    do
        if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/${tag_number}/deploy/${ansible_folder_name}/uninstaller/${file} -o $ansible_folder_name/uninstaller/${file}; then
    ...
    ab_file_lists=`curl --silent https://api.github.com/repos/containers-ai/datadog/contents/deploy/${ab_folder_name}?ref=${tag_number} 2>&1|grep "\"name\":"|cut -d ':' -f2|cut -d '"' -f2`
    ...
    do
        if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/${tag_number}/deploy/${ab_folder_name}/${file} -o $ab_folder_name/${file}; then
    ...
    if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/${tag_number}/deploy/example/${alamedaservice_example} -O; then
    ...
    do
        if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/${tag_number}/deploy/example/${file_name} -O; then
    ...
    if [ "$tag_first_digit" -ge "4" ] && [ "$tag_middle_digit" -ge "3" ]; then
        ...
        do
            if ! curl -sL --fail https://raw.githubusercontent.com/containers-ai/datadog/${tag_number}/deploy/example/${pool}/${alamedascaler_filename} -O; then
    ...
    operator_lists=`curl --silent https://api.github.com/repos/containers-ai/datadog/contents/deploy/upstream?ref=${tag_number} 2>&1|grep "\"name\":"|cut -d ':' -f2|cut -d '"' -f2`
